...
void USBH_USR_Init(void)
{
  ...
  if (startup == 0 ) {
    ...
    USART_puts(USART1," USB OTG HS MSC Host");
#else
    USART_puts(USART1," USB OTG FS MSC Host");
#endif
...
{
 USART_puts(USART1,(void *)MSG_DEV_ATTACHED);
}
...
void USBH_USR_UnrecoveredError (void)
{
  ...
  USART_puts(USART1,(void *)MSG_UNREC_ERROR); 
}
...
{  
  /* Set default screen color*/
  USART_puts(USART1,(void *)MSG_DEV_DISCONNECTED);
}
/**
...
void USBH_USR_DeviceSpeedDetected(uint8_t DeviceSpeed)
{
  if(DeviceSpeed == HPRT0_PRTSPD_HIGH_SPEED) {
    USART_puts(USART1,(void *)MSG_DEV_HIGHSPEED);
  } else if(DeviceSpeed == HPRT0_PRTSPD_FULL_SPEED) {
    USART_puts(USART1,(void *)MSG_DEV_FULLSPEED);
  } else if(DeviceSpeed == HPRT0_PRTSPD_LOW_SPEED) {
    USART_puts(USART1,(void *)MSG_DEV_LOWSPEED);
  } else {
    USART_puts(USART1,(void *)MSG_DEV_ERROR);
  }
}
                                          ...
                                          USBH_EpDesc_TypeDef *epDesc)
{
  ...
  if((*id).bInterfaceClass  == 0x08) {
    USART_puts(USART1,(void *)MSG_MSC_CLASS);
  } else if((*id).bInterfaceClass  == 0x03) {
    USART_puts(USART1,(void *)MSG_HID_CLASS);
  }    
}
...
void USBH_USR_EnumerationDone(void)
{
  ...
  USART_puts(USART1,(void *)MSG_DEV_ENUMERATED);
  
  USART_puts(USART1, "To see the root content of the disk : " );
  USART_puts(USART1, "Press Key...                       ");
...
{
	USART_puts(USART1,"> Device not supported."); 
}  
...
{
  USART_puts(USART1,"Overcurrent detected.");
}
